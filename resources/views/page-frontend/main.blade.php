        ...
        <div class="row" id="about">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Sejarah <span>J.DO</span></h1>
                        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, nihil sapiente! Officia, deleniti molestias debitis velit molestiae pariatur incidunt delectus, fugit consectetur corrupti nesciunt beatae ab magnam tenetur ratione nisi dolore. Qui consequatur soluta maxime molestiae laudantium pariatur, quod vero eos necessitatibus. Repellat blanditiis aperiam, sunt tempora optio sed, impedit minus provident corrupti earum dicta non dolores maxime temporibus est quasi voluptates error illum neque, saepe expedita eveniet eos. Rerum deserunt adipisci numquam accusantium natus incidunt minima. Dolores, expedita in consequuntur dolore consectetur saepe voluptatum recusandae error corporis veniam provident fugit reprehenderit aliquam, id obcaecati voluptas velit unde voluptatibus mollitia.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <img src="assets/images/features-icon-pesan.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <img src="assets/images/features-icon-rating.png" alt="">
                            <h4>Rating</h4>
                            <a href="#testimonials" class="main-button">
                                More Detail
                            </a>
